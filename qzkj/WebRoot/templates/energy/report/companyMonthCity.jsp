...
<body onload=init();thisheight();>
	<div class="position">当前位置：能源消耗数据库系统 &gt;&gt; 能源消耗月度查询 &gt;&gt; 能源消耗月报汇总 &gt;&gt; <a href="#">全市重点用能企业综合能耗汇总表</a></div>
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableout">
      <tr>
        <td>
        <fieldset>
          <legend>查询条件</legend>
          <form name=form1 action="${path}/cyMonthEnyRptCmpCount" method=post >
