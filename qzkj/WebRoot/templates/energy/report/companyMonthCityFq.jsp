...
String dw=(String)request.getAttribute("dw");
%>
...
function init()
{
  if(cell.Login("Beelink software", "","13040483", "7140-0421-0057-6004")==0)
   ...
   url1="${path}/cellTemplate/companyMonthGatherCityFq.cll";
   cell.OpenFile(url1,"");    
   var i=0; 
   var pand=true;
   var startrow=0;
...
<body onload=init();thisheight();>
	<div class="position">当前位置：能源消耗数据库系统 &gt;&gt; 能源消耗数据汇总 &gt;&gt; 综合能耗汇总 &gt;&gt; <a href="#">分区能源消耗月报汇总表</a></div>
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableout">
      <tr>
        <td>
        <fieldset>
          <legend>查询条件</legend>
          <form name=form1 action="${path}/fMonthEnyRptCmpCount" method=post >
          <table border="0" cellpadding="0" cellspacing="3" width="100%">
           <tr>
              ...
              <th>月度范围:</th>
              <td >
                 <select name="beginyd"  id="beginyd" style="width: 63px">
...
<!--               <input type="text" id="beginyd" name="beginyd" value="${beginyd}" style="width: 20px" onkeydown="onlyNum()" onchange="chekvalue(this,1)"/>-->
				--
			  <select name="endyd"  id="endyd" style="width: 63px">
                   <c:forEach items="${yuefen}" var="tmp" varStatus="varsta" >
              ...
              <th>所属区域:</th>
              <td><select name="ssqy"  id="ssqy" style="width: 150px">
			   ...
			   <th>企业名称:</th>
			   <td>
			   	<input type="text" id="dw" value="<%=dw %>"  name="dw"   width="150"/>
			   </td>
...
<!--			  </td>-->
			 ...
			 <th>排&nbsp;&nbsp;&nbsp;&nbsp;序:</th>
				  ...
				  <th>行业分类:</th>
              <td colspan="3"> <select name="hyfl" id="hyfl" onchange="javascript:searchSubmit(1);" style="width: 150px">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableout" >
      <tr>
        <td><fieldset >
           <legend>汇总表</legend>
          <table border="0" cellspacing="0" cellpadding="0" class="list" id="table1" >
           <tr>
