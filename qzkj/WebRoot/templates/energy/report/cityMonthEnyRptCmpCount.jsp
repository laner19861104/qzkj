...
<HTML>
 <HEAD>
  ...
  <link href="<%=request.getContextPath() %>/templates/css/main_top.css" rel="stylesheet" type="text/css" />
	...
	<script type="text/javascript" src="<%=request.getContextPath() %>/templates/energy/report/js/cityMonthEnyRptCmpCount.js"></script>
    <script type="text/javascript" src="<%=request.getContextPath() %>/templates/js/setmonth1.js"></script>
...
<div region="center" split="true" title="当前位置：能源预测预警系统  &gt;&gt; 单耗预警 (红色:超过国家标准  黄色:超过省标准 绿色:正常 白色:没有对应标准)" style="width:320px;height:100%;padding1:1px;overflow:hidden;">	
	...
	<table width="100%" class="title_table" border="0" cellpadding="0" cellspacing="0" >
		...
		<td><input type="text" name="entername" id="entername" size="21" class="input_text"/>
		<input type="hidden" name="entercode" id="entercode"></td>
		<td width="230">&nbsp;</td>
		<td rowspan="2" align="right"> <a class="easyui-linkbutton" iconCls="icon-search" href="javascript:void(0);" onClick="q2_search()">查询</a>&nbsp;&nbsp;</td>
		...
		</select><select calss="easyui-combotree" id="hyname"  style="display: none"></select>
		</td>
