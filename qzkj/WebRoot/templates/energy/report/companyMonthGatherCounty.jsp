...
String resStr="";
String ssqy="";
if(resMap.get("ssqy")!=null)
  ssqy=resMap.get("ssqy").toString();
...
function init()
{
  if(cell.Login("Beelink software", "","13040483", "7140-0421-0057-6004")==0)
   ...
   url1="${path}/cellTemplate/companyMonthGatherCounty.cll";
   cell.OpenFile(url1,"");    
   var i=0; 
   var pand=true;
   var startrow=0;
...
<body onload=init()>
	<div class="position">当前位置：能源消耗数据库系统 &gt;&gt; 能源消耗数据汇总 &gt;&gt; 综合能耗汇总 &gt;&gt; <a href="#">各县市区重点用能企业综合能耗汇总表</a></div>
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableout">
      <tr>
        <td>
        <fieldset>
          <legend>查询条件</legend>
          <form name=form1 action="${path}/countyMonthEnyRptCmpCount" method=post >
