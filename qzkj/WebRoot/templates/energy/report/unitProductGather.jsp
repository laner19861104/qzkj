...
function init()
{
  if(cell.Login("Beelink software", "","13040483", "7140-0421-0057-6004")==0)
   ...
   url1="${path}/cellTemplate/unitProductGather.cll";
   cell.OpenFile(url1,"");    
   var i=0; 
   var pand=true;
   var startrow=0;
...
<body onload=init();thisheight();>
	<div class="position">当前位置：能源消耗数据库系统 &gt;&gt; 能源消耗数据汇总 &gt;&gt; 产品综合能耗指标汇总 &gt;&gt; <a href="#">全市分县市区重点用能企业单位产品综合能耗指标汇总表</a></div>
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableout">
      <tr>
        <td>
        <fieldset>
          <legend>查询条件</legend>
           <form name=form1 action="${path}/cityFqEnyRptUnitCount" method=post >
