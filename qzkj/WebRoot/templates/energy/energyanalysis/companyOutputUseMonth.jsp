...
<div class="position">当前位置：能耗水平评价系统 >> 主要行业能源利用状况 >> 企业能耗状况分析 >> 企业产值能耗情况</div>
<br/>
  ...
  <table border="0" cellpadding="0" cellspacing="0" class="Menubox">
	  <tr>
		<td><ul>
			<li id="one1"  class="hover"><span style="font-size:12px;">（月份）企业各月产值能耗情况</span></li>
		  	<li id="one2"><span style="font-size:12px;"><a href="#" target="_self">	（年度）企业各年产值能耗情况</a></span></li>
		</ul></td>
	  </tr>
	</table>
   <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableout">
			...
			<tr>
			  <td>
					<table border="0" cellspacing="0" cellpadding="0" class="list" id="table1"  width="100%">
			          <tr>
					    <th height="40" colspan="2" rowspan="2"><p >指标名称</p></th>
					  ...
					  <td width="100"><div align="center">当量值</div></td>
					  ...
					  <tr>
					    <td><div align="center">等价值</div></td>
				        <td width="75"><div align="center">3333</div></td>
					    <td width="75"><div align="center">3333</div></td>
					    <td width="75"><div align="center">3333</div></td>
					    <td width="75"><div align="center">3333</div></td>
					  ...
					  <td><div align="center">当量值</div></td>
					  <td width="75"><div align="center">2222</div></td>
					  <td width="75"><div align="center">3333</div></td>
					  <td width="75"><div align="center"></div></td>
					  <td width="75"><div align="center">4444</div></td>
