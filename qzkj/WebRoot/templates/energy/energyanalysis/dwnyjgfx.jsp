...
<!--</c:if>-->
<body>
<div class="position">当前位置：能耗水平评价系统 >> 能源利用状况  >> 企业能耗状况分析 >> 单位能源结构分析</div>
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableout">
   ...
   <form action="<%=request.getContextPath()%>/energydwnyjgfx" name="formlist" method="post">
...
<!--    <td align="center">${varsta.count}&nbsp;</td>-->
    <td width="31%">${tmp.nymc}&nbsp;</td>
    <td width="12%">${tmp.jldw}&nbsp;</td>
    <td width="12%">${tmp.swl}&nbsp;</td>
    <td width="12%">${tmp.zbl}&nbsp;</td>
    <td width="12%">${tmp.zzsbl}&nbsp;</td>
