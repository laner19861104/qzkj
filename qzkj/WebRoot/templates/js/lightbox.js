...
this.Lay.style.width = this.Lay.style.height = "100%";
  ...
  //显示
  Show: function() {
	  parent.leftFrame.document.all.ly.style.display="block";         
	  parent.leftFrame.document.all.ly.style.width=205;         
	  parent.leftFrame.document.all.ly.style.height=1000; 
//设置样式
