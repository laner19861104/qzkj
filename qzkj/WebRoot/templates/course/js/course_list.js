var urls = eval( {
	"query" : "query_queryCourseAction_query.action",
	"add" : "modify_editCourseAction_add.action",
	"edit" : "modify_editCourseAction_edit.action",
	"del" : "modify_editCourseAction_del.action",
	"get":"get_queryCourseAction_get.action"
});
$(function() {
	$('#mForm').hide();
	$('#tList').datagrid( {
		...
		{title : '课程编号', field : 'code', width:200, align:'left', sortable:true},
		{title : '课程名称', field : 'name', width:200, align:'left', sortable:true},
		{title : '所属科目',	field : 'subjectName', width : 200,	align:'left', sortable:true},
