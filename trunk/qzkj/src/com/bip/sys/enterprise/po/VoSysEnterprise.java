...
public class VoSysEnterprise implements java.io.Serializable {
	...
	/** default constructor */
	public VoSysEnterprise() {
	}

	/** minimal constructor */
	public VoSysEnterprise(int id) {
		this.id = id;
	}

	// Property accessors
	public VoSysEnterprise(int id, String dwbh, String dwmc, String xxdz)
	{
		this.id=id;
		this.dwbh=dwbh;
		this.dwmc=dwmc;
