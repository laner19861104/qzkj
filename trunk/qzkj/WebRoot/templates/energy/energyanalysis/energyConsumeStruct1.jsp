...
<br/>
          <form action="${path}/energyConsumeStruct.action" name="formlist" method="post">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="Menubox">
	  <tr>
		<td><ul>
		 	<li id="one1"><span style="font-size:12px;"><a href="#" onclick="actionShowChart('${path}/energyConsumeStruct.action?urlaction=userStruct')" > 能源消费结构 </a></span></li>
			<li id="one2"  class="hover"><span style="font-size:12px;">行业能源消费结构</span></li>
		</ul></td>
	  </tr>
	</table>
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableout">
						  ...
						  <tr> 
						     <td valign="top" class="text" align="center"> 
						        ...
						        <script type="text/javascript">
								   var chart = new FusionCharts("${path}/charts/Charts/FCF_MSColumn2D.swf", "ChartId", "700", "400", "0", "0");
								   chart.setDataXML("${xmlStr}");	   
								   chart.render("chartdiv");
								   
								</script> 
						     </td>
						    <td valign="top" class="text" align="center" style="display:none"> 
						    	<div id="chartdiv2" align="center"> 图标 </div>
						        <script type="text/javascript">
								   var chart = new FusionCharts("${path}/charts/Charts/FCF_MSColumn2D.swf", "ChartId", "370", "400", "0", "0");
								   chart.setDataXML("${xmlStr}");	   
     ...
     <td valign="top">
        ...
        <fieldset ><legend>${tjflname}</legend>
		   <table width="150" height="500" border="0" cellpadding="0" cellspacing="0" class="tableout">
			    <tr>
				  <td valign="top">
					  <div class="fenlei">
						<ul>
							<c:forEach items="${tjflList}" var="tmp" varStatus="varsta" >
							<li><a href="#" onclick="tjflShowChart('${path}/energyStructShowChart.action?urlaction=${urlaction}','${tmp.bh}')" >${tmp.mc} </a></li>
							</c:forEach> 
						</ul>
					  </div>
				  </td>
...
<script type="text/javascript">
   showChart('${path}/energyStructShowChart.action?urlaction=${urlaction}&nd=${nd}&yuefen1=${yuefen1}&yuefen2=${yuefen2}&fxmb=${fxmb}&tjlb=${tjlb}&tjfl=${tjfl}&bbzt=${bbzt}&bh=${bh}');
</script>
