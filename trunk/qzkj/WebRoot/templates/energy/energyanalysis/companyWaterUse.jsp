...
<div class="position">当前位置：能耗水平评价系统 >> 主要行业能源利用状况 >> 企业能耗状况分析 >> 企业水资源消耗情况</div>
<br/>
  ...
  <table border="0" cellpadding="0" cellspacing="0" class="Menubox">
	  <tr>
		<td><ul>
			<li id="one1"  class="hover"><span style="font-size:12px;">（月份）企业各月总耗水情况</span></li>
		  	<li id="one2"><span style="font-size:12px;"><a href="#" target="_self">（年度）企业各年总耗水情况</a></span></li>
		</ul></td>
	  </tr>
	</table>
   <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tableout">
