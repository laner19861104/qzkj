...
function loadCell1(){
   url1="${path}/cellTemplate/zynhsbzkb.cll";
   cell.OpenFile(url1,"");    
   var i=0; 
   var pand=true;
   var startrow=0;
 ...
 <table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr>
	  <td>
			  ...
			  <tr>
				<td><ul>
					<li id="one1" class="hover"><span style="font-size:12px;">主要能耗设备状况表</span></li>
				  	...
				  	<li id="one3" ><span style="font-size:12px;"><a href="${path}/facilityStatusRYEnyRpt?zbid=<%=sbinfoMap.get("zbid")%>&dwbh=<%=resMap.get("dwbh")%>&nd=<%=resMap.get("nd")%>&yd=<%=resMap.get("yd")%>" target="_self">操作人员培训情况汇总表</a></span></li>
				</ul></td>
			  </tr>
			</table>
